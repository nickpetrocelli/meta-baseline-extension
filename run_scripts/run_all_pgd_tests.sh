...
#qsub -m abes -l gpus=1 -cwd -e test_errors/tiered_5shot_pgd_nocorr_err.txt -o test_results/tiered_5shot_pgd_nocorr_out.csv -N tiered_5shot_pgd_nocorr run_scripts/run_test_1gpu_pgd.sh configs/test/test_few_shot_tiered_5shot_sqr.yaml 5
sleep 5h
qsub -m abes -l gpus=1 -cwd -e test_errors/tiered_5shot_pgd_corr_err.txt -o test_results/tiered_5shot_pgd_corr_out.csv -N tiered_5shot_pgd_corr run_scripts/run_test_1gpu_pgd_corrupted.sh configs/test/test_few_shot_tiered_5shot_sqr.yaml 5
